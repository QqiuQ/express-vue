    ...
    <el-row type="flex" justify="center">
      <el-col :span="6">
        <el-card style="margin-top: 50px;">
          ...
          <el-form class="container" :model="userForm" :rules="rules" ref="userForm" label-width="100px" >
            ...
            <el-form-item label="确认密码" prop="confirmPwd">
              <el-input placeholder="请再次输入密码" v-model="userForm.confirmPwd" show-password></el-input>
            </el-form-item>
