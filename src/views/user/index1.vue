<template>
    <div class="app-container">
        <div class="filter-container">
            ...
            <!-- <el-select  placeholder="Imp" clearable style="width: 90px"
                class="filter-item">
        ...
        <el-table v-loading="listLoading" :data="userList" border fit highlight-current-row
            ...
            <el-table-column label="昵称" prop="nickname" align="center" width="80">
                <template slot-scope="{row}">
            ...
            <el-table-column label="上次登录时间" class-name="status-col" width="100">
                <template slot-scope="{row}">
                        {{ row.lastLoginTime }}
                </template>
            </el-table-column>
            <el-table-column label="账户状态" class-name="status-col" width="100">
                <template slot-scope="{row}">
                        {{ row.accountStatus }}
                </template>
            </el-table-column>
